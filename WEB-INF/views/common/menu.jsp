    ...
    <ul class="page-sidebar-menu" id="#page-sidebar-menu">
        ...
        <li id="setting" class="">
            ...
            <ul class="sub-menu" id="s_setting">
                ...
                <li id="update_classfi" class=""><a href="rest/updateclass"><i class="fa fa-caret-right"></i>更新分类</a>
                </li>
                <li id="add_device" class=""><a href="rest/adddev"><i class="fa fa-caret-right"></i>新增设备</a></li>
                <li id="update_device" class=""><a href="rest/updatedev"><i class="fa fa-caret-right"></i>更新设备</a></li>
                <li id="setPsWrd">
